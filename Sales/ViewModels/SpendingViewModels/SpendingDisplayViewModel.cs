...
namespace Sales.ViewModels.SpendingViewModels
{
    public class SpendingDisplayViewModel : ValidatableBindableBase
    {
        ...
        private SafeServices _safeServ = new SafeServices();
        private SpendingServices _spendingServ = new SpendingServices();
        ...
        private Spending _newSpending = new Spending();
        ...
        private List<string> _statementSuggestions = new List<string>();
