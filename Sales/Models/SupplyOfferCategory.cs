...
{
   public class SupplyOfferCategory : ValidatableBindableBase
    {
        ...
        private int _supplyOfferID;
        [Key, Column(Order = 2)]
        public int SupplyOfferID
        {
            get { return _supplyOfferID; }
            set { SetProperty(ref _supplyOfferID, value); }
        }
    ...
    public class SupplyOfferCategoryVM : ValidatableBindableBase
    {
        private int _categoryID;
        public int CategoryID
        {
